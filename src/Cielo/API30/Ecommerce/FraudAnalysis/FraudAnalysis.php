...
class FraudAnalysis implements CieloSerializable
{
    ...
    /** @var bool|null Quando true, o estorno deve acontecer automaticamente quando o risco de fraude for considerado alto (Reject).
    ...
    /** @var float Valor total do pedido. */
